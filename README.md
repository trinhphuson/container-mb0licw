...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-mb0licw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-mb0licw.containers.anotherwebservice.com/
...
```
git clone git@github.com:trinhphuson/container-mb0licw.git
cd container-mb0licw
```
...
```
docker attach container-mb0licw
```
